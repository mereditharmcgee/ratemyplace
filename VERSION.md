...
**New Features:**
- Property Manager System: Buildings can now have both a landlord (owner) AND a property manager
...
### v1.1.0-alpha - "Discovery" (Planned)
...
| Google Maps API | Planned | v1.1.0 |
| Google OAuth | Planned | v1.1.0 |
| Interactive Map | Planned | v1.1.0 |
| Review Moderation | Planned | v1.2.0 |
