# Requirements Archive: v1.3 Battle Tested
...
- [x] **SEC-04**: Unauthenticated requests to protected API endpoints return 401
- [x] **SEC-05**: Non-admin requests to admin API endpoints return 403
