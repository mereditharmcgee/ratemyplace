      ...
      <div className={sectionClass}>
        ...
        <form onSubmit={handleNameSave}>
          ...
          <input
            ...
            className="w-full max-w-sm px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
          />
